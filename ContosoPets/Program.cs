...
do
{
    ...
    switch (menuSelection)
    {
        case "1":
            ...
            //Lista de animales con sus caracteristicas
            for (int i = 0; i < maxPets; i++)
            {
            ...
            while (anotherPet == "y" && petCount < maxPets)
            {
                ...
                do
                {
                    ...
                    if (readResult != null)
                    {
                        ...
                        {
                            Console.WriteLine("You did not enter a valid species. Please try again.");
                            validEntry = false;
                        }
                    }
                ...
                //animal personality description
                do
                {
        ...
        default:
            Console.WriteLine("Exit succesful.");
            break;
    }
